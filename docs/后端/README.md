...
- 已完成核心逻辑数据模型，并使用开发期 SQLite 实现 `users`、`subjects`、`assistant_global_settings`、`assistant_private_spaces`、`assistant_private_content_versions`、对话/摘要/状态、事件、模型路由、能力/设备注册、权限/安全/确认/审计及迁移记录。
