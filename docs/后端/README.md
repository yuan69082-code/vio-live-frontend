...
R0-A/B/C 及 R0 整阶段已验收并推送；状态卡本身不证明独立聊天完成。R2 个人所有者访问、首次设置、同用户多助手、会话撤销、访问审计/诊断、Provider/Model、加密凭据、认证连接检查及 7/14/30 天政策下的受控账户删除，以及 R1 真实个人会话/当前助手范围的独立聊天合同、迁移 `025` 与 Vio 自有执行/恢复边界，均已于 **2026-09-05 正式验收通过**。R3 的多会话目录、消息版本/分支、受控再生成、附件、导出、迁移 `026`、前后端实现和受控页面闭环已于 **2026-09-06 正式验收通过**；邮箱、Google 和公开注册继续暂缓。
